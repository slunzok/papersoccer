...
function rotate() {
    ...
    document.getElementById("id_moves").value = moves.join(" ");
    drawGameState();
}
...
function setGmochMode() {
    ...
    if (multiMove == 0) {
        if (gmochMode == 0) {
            ...
            document.getElementById("back_accept").value = "zatwierdź ruch";
            ...
            document.getElementById("back_accept").value = "cofnij ruch";
